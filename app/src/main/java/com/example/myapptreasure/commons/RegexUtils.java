package com.example.myapptreasure.commons;
...
public enum RegexUtils {
     ...
     */
    public static RegexUtils verifyUsername(@NonNull String username) {
     ...
     * @return {@link #VERIFY_SUCCESS}, {@link #VERIFY_TYPE_ERROR}, {@link #VERIFY_LENGTH_ERROR}
     */
    public static RegexUtils verifyPassword(@NonNull String password) {
