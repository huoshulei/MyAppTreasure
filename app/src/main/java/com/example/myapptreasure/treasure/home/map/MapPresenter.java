...
import com.example.myapptreasure.net.NetClient;
import com.example.myapptreasure.treasure.Area;
import com.example.myapptreasure.treasure.Treasure;
import com.example.myapptreasure.treasure.TreasureApi;
...
public class MapPresenter extends MvpNullObjectBasePresenter<MapMvpView> {
    ...
    public void getTreasure(Area area) {
        ...
        this.area = area;
        TreasureApi treasureApi = NetClient.netClient.getTreasureApi();
