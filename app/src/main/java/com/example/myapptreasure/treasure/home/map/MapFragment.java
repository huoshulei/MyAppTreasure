package com.example.myapptreasure.treasure.home.map;
...
import com.example.myapptreasure.components.TreasureView;
import com.example.myapptreasure.treasure.Area;
import com.example.myapptreasure.treasure.Treasure;
import com.example.myapptreasure.treasure.TreasureRepo;
import com.example.myapptreasure.treasure.hide.HideTreasureActivity;
import com.example.myapptreasure.treasure.home.map.MapMvpView;
import com.example.myapptreasure.treasure.home.map.MapPresenter;
...
public class MapFragment extends MvpFragment<MapMvpView, MapPresenter> implements MapMvpView {
    ...
    @BindView(R.id.map_frame) FrameLayout mapFrame;
     ...
     * 在埋藏宝藏时，下方卡片上显示的埋藏位置
     */
    @BindView(R.id.tv_currentLocation) TextView tvCurrentLication;
    ...
    @BindView(R.id.et_treasureTitle)EditText     etTreasureTitle;// 信息录入编辑框(埋藏宝藏时)
     ...
     */
    @BindView(R.id.layout_bottom) FrameLayout bottomLayout;
    /**
     * 埋藏宝藏时需要(中心位置藏宝控件)
     */
    @BindView(R.id.centerLayout) RelativeLayout conterLayout;
    /**
     * 埋藏宝藏时的信息录入卡片(在屏幕下方位置)
     */
    @BindView(R.id.hide_treasure) RelativeLayout hideTreasure;
    /**
     * 埋藏宝藏时"藏在这里"的按钮
     */
    @BindView(R.id.btn_HideHere) Button btnHideHere;
    @BindView(R.id.iv_located) ImageView ivLocated;
